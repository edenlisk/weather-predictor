...
// final access key: AAAVVSRM4JR5WA7KMTFA3T44E
// final API endpoint: https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Kigali/2023-02-14/2023-02-17?unitGroup=metric&include=days&key=YOUR_API_KEY&contentType=json
// const BASE_URL = 'http://api.weatherstack.com/current';
// const ACCESS_KEY = '20e04a1fb35ee7efafef28b701e11f36';
...
// function checkAvailableCity(search) {
//   for (let i = 0; i < cities.length; i += 1) {
//     if (cities[i].includes(capitalizeFirstLetter(search))) return cities[i];
//   }
// }

// export const handleSearching = createAction(SEARCH_CITY, (matchCity) => {
//   const matched = checkAvailableCity(matchCity);
//   if (matched) return { payload: matched};
// })
...
// const fetchCitiesWeathers = () => {
//   // const newData = fetchSingleCity('Kigali');
//   // console.log(newData);
//   // return newData;
// };
...
export const retrieveWeather = createAsyncThunk(FETCH_CITY_WEATHERS, async (obj, thunkAPI) => {
  ...
  if (currentState.weather.length === 0) {
    ...
    // const newinfo = [...weatherData, newData];
    // console.log(newinfo);
    // let newInfo = [];
    // await cities.map(async (ct) => {
    //   const newData = await fetchSingleCity(ct);
    //   // console.log(newData)
    //   newInfo = await [...newInfo, newData];
    //   // console.log(newInfo)
    // })
    // await console.log(newInfo);
    // fetchCitiesWeathers();
    // const response = fetchCitiesWeathers();
...
export const weatherReducer = createReducer(INITIAL_STATE, ((builder) => {
  builder
    ...
    // .addCase(selectCity, ((state, action) => state.filter(city =>
  // city.location.name === action.payload)))
...
// TODO : THINK ABOUT CHANGE OF APPROACH OF GETTING SELECTED ITEM (selected: true)
...
//       "severerisk": 10,
//       "sunrise": "07:16:56",
//       "sunriseEpoch": 1676359016,
//       "sunset": "17:13:17",
//       "sunsetEpoch": 1676394797,
//       "moonphase": 0.79,
//       "conditions": "Partially cloudy",
...
//       "severerisk": 10,
//       "sunrise": "07:13:06",
//       "sunriseEpoch": 1676531586,
//       "sunset": "17:16:56",
//       "sunsetEpoch": 1676567816,
//       "moonphase": 0.85,
//       "conditions": "Overcast",
...
//       "severerisk": 10,
//       "sunrise": "07:11:10",
//       "sunriseEpoch": 1676617870,
//       "sunset": "17:18:45",
//       "sunsetEpoch": 1676654325,
//       "moonphase": 0.89,
//       "conditions": "Partially cloudy",
//       "description": "Partly cloudy throughout the day.",
//       "icon": "partly-cloudy-day",
...
//       "severerisk": 10,
//       "sunrise": "07:09:12",
//       "sunriseEpoch": 1676704152,
//       "sunset": "17:20:35",
//       "sunsetEpoch": 1676740835,
//       "moonphase": 0.92,
//       "conditions": "Overcast",
//       "description": "Cloudy skies throughout the day.",
//       "icon": "cloudy",
...
//       "severerisk": 10,
//       "sunrise": "07:07:12",
//       "sunriseEpoch": 1676790432,
//       "sunset": "17:22:24",
//       "sunsetEpoch": 1676827344,
//       "moonphase": 0.96,
//       "conditions": "Partially cloudy",
//       "description": "Partly cloudy throughout the day.",
//       "icon": "partly-cloudy-day",
...
//       "severerisk": 10,
//       "sunrise": "07:05:12",
//       "sunriseEpoch": 1676876712,
//       "sunset": "17:24:12",
//       "sunsetEpoch": 1676913852,
//       "moonphase": 0.99,
//       "conditions": "Clear",
//       "description": "Clear conditions throughout the day.",
//       "icon": "clear-day",
...
//       "cloudcover": 0,
//       "visibility": 24.1,
//       "solarradiation": 121.1,
//       "solarenergy": 10.6,
//       "uvindex": 4,
//       "severerisk": 10,
//       "sunrise": "07:03:10",
//       "sunriseEpoch": 1676962990,
//       "sunset": "17:26:01",
//       "sunsetEpoch": 1677000361,
//       "moonphase": 0.02,
//       "conditions": "Clear",
//       "description": "Clear conditions throughout the day.",
//       "icon": "clear-day",
