...
import {legacy_createStore as createStore, combineReducers, applyMiddleware, createAction} from "@reduxjs/toolkit";
...
describe("Test pure functions", () => {
    ...
    test("Test redux store weather information default case", () => {
        ...
        // TODO : REPLACE INITIAL STATE IN NEXT TO EMPTY ARRAY []
        expect(currentState.weather).toEqual(INITIAL_STATE);
    })
